        ...
        <div class="box box-success" style="border-top:#00897b 6px solid;">
            <div class="box-header">
                <h3 class="box-title">
                  ...
                  <a href="javascript:" onClick="sycndb()" class="btn btn-sm btn-flat btn-default"><i class="fa fa-refresh"></i> SYCNDB</a>
                </h3>
            </div>
...
{
    $.ajax({
            url: base_url+"<?php echo $this->uri->segment(1); ?>/sycndb",
            cache: false,
            indicatorId: '#load_ajax',
            beforeSend: function(){
                $('#load_ajax').fadeIn(100);
