...
*/
/*NAMA APPS*/
/*Nama apps ini akan muncul selalu di header aplikasi */
$config['alus']['nama_app'] 	= "ALUS BASE";
$config['alus']['desc_app'] 	= "Aplikasi Base Milik ALUS.CO sebagai dasar pembuatan website";
$config['alus']['keyword_app'] 	= "ALUS BASE";
$config['alus']['author_app'] 	= "ALUS.CO";
/*
| -------------------------------------------------------------------------
| Tables.
| -------------------------------------------------------------------------
...
$config['passwordemailku'] = hex2bin('1234567890');
